...
import com.ksw.movielist.ui.detailMovie.SingleMovie
...
class MoviePagedListAdapter(val context: Context) :
    ...
    class MovieItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: Movie, context: Context) {
            itemView.tv_card_movieTitle.text = movie.title
            itemView.tv_card_releaseDate.text = movie.releaseDate

            val moviePosterUrl = POSTER_BASE_URL + movie.posterPath
            Glide.with(itemView.context)
                .load(moviePosterUrl)
                .into(itemView.iv_card_moviePoster)
    ...
    class NetworkStateItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(networkState: NetworkState?) {
            ...
            if (networkState != null && networkState == NetworkState.ERROR) {
                itemView.tv_errorMessage.visibility = View.VISIBLE;
                itemView.tv_errorMessage.text = networkState.msg;
            } else if (networkState != null && networkState == NetworkState.END) {
                itemView.tv_errorMessage.visibility = View.VISIBLE;
                itemView.tv_errorMessage.text = networkState.msg;
            } else {
                itemView.tv_errorMessage.visibility = View.GONE;
            }
        }
    }
